...
const baseImpl: Implementation = {
  ...
  business_hours_start_local: 0,
  business_hours_end_local: 24,
  deleted_at: null,
...
// Cross-implementation trainer busy intervals were removed in the
// simplification to single-project scheduling. PTO/unavailability tests
// further down cover the remaining "trainer busy" code path.
